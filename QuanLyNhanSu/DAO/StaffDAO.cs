...
namespace QuanLyNhanSu.DAO
{
	public class StaffDAO
	{
		...
		public static StaffDAO Instance { get => instance==null ? instance = new StaffDAO() : instance; private set => instance=value; }

		private StaffDAO() { }


		public List<StaffDTO> GetInforNV()
		{
		...
		public List<StaffDTO> SearchStaff(string value, DateTime? date = null)
		{
			List<StaffDTO> list = new List<StaffDTO>();
