...
namespace QuanLyNhanSu.DAO
{
	public class TrainingDAO
	{
		...
		public static TrainingDAO Instance { get => instance==null ? instance = new TrainingDAO() : instance; private set => instance=value; }

		private TrainingDAO() { }


		public List<TrainingDTO> GetListDaoTao()
		{
			...
			{
				TrainingDTO training = new TrainingDTO(item);
		...
		public List<TrainingDTO> SearchTraining(string value)
		{
			List<TrainingDTO> list = new List<TrainingDTO>();
