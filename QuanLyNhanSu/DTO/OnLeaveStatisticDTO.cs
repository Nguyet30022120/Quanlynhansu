...
{
	public class OnLeaveStatisticDTO
	{
		public OnLeaveStatisticDTO(string maNV, string tenNV, DateTime ngayBD, DateTime ngayKT, string lyDo, string trangThai)
		{
			this.maNV = maNV;
			this.tenNV = tenNV;
			this.ngayBD = ngayBD;
		...
		public OnLeaveStatisticDTO(DataRow row)
		{
