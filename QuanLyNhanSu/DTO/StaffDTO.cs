...
namespace QuanLyNhanSu.DTO
{
	...
	{
		public StaffDTO(string maNV,string maChucVu, string maPB, string hoTen, string chucVu, string phongBan, string taiKhoan, string cCCD, string dienThoai, string tDHV, string diaChi, int gioiTinh, DateTime? ngaySinh, string trinhDo, string maTrinhDo, string email)
		{
			this.MaNV = maNV;
			this.HoTen = hoTen;
			this.ChucVu = chucVu;
