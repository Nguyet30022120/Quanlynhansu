...
{
	public class ThongkekhenthuongkyluatDTO
	{
		public ThongkekhenthuongkyluatDTO(string tenNV, string maNV, int nam, int khenThuong, int kyLuat)
		{
			this.tenNV = tenNV;
			this.maNV = maNV;
			this.nam = nam;
		...
		public ThongkekhenthuongkyluatDTO(DataRow row)
		{
