...
namespace QuanLyNhanSu.DTO
{
	...
	{
		public UserDTO (string tenNV, string maNV, string chucVu, string cuaHang, string maTK, string taiKhoan, string vaiTro, string moTaQUyenHan, DateTime ngaySinh, int gioiTinh, string diaChi,
