...
namespace QuanLyNhanSu.GUI
{
	public partial class fBangluong : Form
	{
		...
		public fBangluong()
		{
			...
			//originalLuuBangLuongButtonColor = btn_luubangluong.BackColor; // Uncomment if you have a save button
		}
		...
		//private void btn_luubangluong_Click_1(object sender, EventArgs e)
		//{
		//	if (danhSachLuong == null || danhSachLuong.Count == 0)
		//	{
		...
		// Remove the duplicate InitializeComponent method
