namespace QuanLyNhanSu.GUI
{
	partial class fQuanlybangcong
	{
		...
		private void InitializeComponent()
		{
			...
			this.pn_chuthich = new System.Windows.Forms.Panel();
			...
			this.pn_bangcong.SuspendLayout();
			...
			// pn_bangcong
			// 
			this.pn_bangcong.BackColor = System.Drawing.Color.BlanchedAlmond;
			this.pn_bangcong.Controls.Add(this.txb_tennhanvien);
			this.pn_bangcong.Controls.Add(this.txb_manhanvien);
			this.pn_bangcong.Controls.Add(this.label1);
			this.pn_bangcong.Controls.Add(this.btn_close);
			this.pn_bangcong.Controls.Add(this.btn_xuatbaocao);
			this.pn_bangcong.Controls.Add(this.btn_xem);
			this.pn_bangcong.Controls.Add(this.cb_nam);
			this.pn_bangcong.Controls.Add(this.cb_thang);
			this.pn_bangcong.Controls.Add(this.lb_manhanvien);
			this.pn_bangcong.Controls.Add(this.lb_nam);
			this.pn_bangcong.Controls.Add(this.lb_thang);
			this.pn_bangcong.Dock = System.Windows.Forms.DockStyle.Top;
			this.pn_bangcong.Location = new System.Drawing.Point(0, 0);
			this.pn_bangcong.Name = "pn_bangcong";
			this.pn_bangcong.Size = new System.Drawing.Size(1482, 129);
			this.pn_bangcong.TabIndex = 0;
			// 
			// txb_tennhanvien
			// 
			...
			this.txb_tennhanvien.Location = new System.Drawing.Point(150, 80);
			...
			this.txb_manhanvien.Location = new System.Drawing.Point(150, 30);
			...
			this.btn_close.Location = new System.Drawing.Point(1613, 47);
			...
			this.btn_xuatbaocao.Location = new System.Drawing.Point(1413, 47);
			...
			this.btn_xem.Location = new System.Drawing.Point(1240, 47);
			...
			this.cb_nam.Location = new System.Drawing.Point(596, 30);
			this.cb_nam.Name = "cb_nam";
			this.cb_nam.Size = new System.Drawing.Size(102, 28);
			...
			this.cb_thang.Location = new System.Drawing.Point(596, 80);
			...
			this.lb_manhanvien.Location = new System.Drawing.Point(12, 30);
			...
			this.lb_nam.Location = new System.Drawing.Point(497, 30);
			...
			this.lb_thang.Location = new System.Drawing.Point(497, 80);
			...
			this.panel_calendar.Controls.Add(this.pn_chuthich);
			...
			this.pn_days.Size = new System.Drawing.Size(1480, 483);
			this.pn_days.TabIndex = 0;
			// 
			// pn_chuthich
			// 
			this.pn_chuthich.BackColor = System.Drawing.Color.BlanchedAlmond;
			this.pn_chuthich.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
			this.pn_chuthich.Controls.Add(this.label_red);
			this.pn_chuthich.Controls.Add(this.button_red_sample);
			this.pn_chuthich.Controls.Add(this.label_green);
			this.pn_chuthich.Controls.Add(this.button_green_sample);
			this.pn_chuthich.Controls.Add(this.lb_chuthich);
			this.pn_chuthich.Dock = System.Windows.Forms.DockStyle.Bottom;
			this.pn_chuthich.Location = new System.Drawing.Point(0, 483);
			this.pn_chuthich.Margin = new System.Windows.Forms.Padding(3, 2, 3, 2);
			this.pn_chuthich.Name = "pn_chuthich";
			this.pn_chuthich.Size = new System.Drawing.Size(1480, 64);
			this.pn_chuthich.TabIndex = 2;
			// 
			// label_red
			// 
			...
			// lb_chuthich
			// 
			this.lb_chuthich.BackColor = System.Drawing.Color.DarkGray;
			this.lb_chuthich.Dock = System.Windows.Forms.DockStyle.Top;
			this.lb_chuthich.Font = new System.Drawing.Font("Segoe UI", 12F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.lb_chuthich.ForeColor = System.Drawing.Color.Black;
			this.lb_chuthich.Location = new System.Drawing.Point(0, 0);
			this.lb_chuthich.Name = "lb_chuthich";
			this.lb_chuthich.Size = new System.Drawing.Size(1478, 28);
			this.lb_chuthich.TabIndex = 0;
			this.lb_chuthich.Text = "CHÚ THÍCH";
			this.lb_chuthich.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
			// 
			// panel3
			// 
			this.panel3.BackColor = System.Drawing.Color.Tan;
			this.panel3.Controls.Add(this.lb_tonggio);
			this.panel3.Controls.Add(this.lb_tonggiolam);
			...
			this.lb_tonggio.Location = new System.Drawing.Point(956, 26);
			...
			this.lb_tonggiolam.Location = new System.Drawing.Point(690, 34);
			...
			this.pn_bangcong.ResumeLayout(false);
			this.pn_bangcong.PerformLayout();
			this.panel2.ResumeLayout(false);
			this.panel_calendar.ResumeLayout(false);
			this.pn_chuthich.ResumeLayout(false);
			this.pn_chuthich.PerformLayout();
		...
		private System.Windows.Forms.Panel pn_bangcong;
		...
		private System.Windows.Forms.Panel pn_chuthich;
