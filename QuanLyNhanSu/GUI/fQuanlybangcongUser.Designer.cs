namespace QuanLyNhanSu.GUI
{
	partial class fQuanlybangcongUser
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(fQuanlybangcongUser));
			...
			this.pn_chuthich.Controls.Add(this.label2);
			this.pn_chuthich.Controls.Add(this.button1);
			this.pn_chuthich.Controls.Add(this.label3);
			this.pn_chuthich.Controls.Add(this.button2);
			this.pn_chuthich.Controls.Add(this.lb_chuthich);
			this.pn_chuthich.Dock = System.Windows.Forms.DockStyle.Bottom;
			this.pn_chuthich.Location = new System.Drawing.Point(0, 614);
			this.pn_chuthich.Margin = new System.Windows.Forms.Padding(3, 2, 3, 2);
			this.pn_chuthich.Name = "pn_chuthich";
			this.pn_chuthich.Size = new System.Drawing.Size(1482, 64);
			this.pn_chuthich.TabIndex = 14;
			// 
			// label2
			// 
			...
			this.label2.Text = "Chưa chấm công";
			// 
			// button1
			// 
			...
			this.lb_chuthich.Size = new System.Drawing.Size(1480, 28);
			...
			this.Controls.Add(this.pn_chuthich);
