namespace QuanLyNhanSu.GUI
{
	partial class fQuanlyphucapUser
	{
		...
		private void InitializeComponent()
		{
			...
			this.dgv_phucap.AlternatingRowsDefaultCellStyle = dataGridViewCellStyle3;
			...
			this.dgv_phucap.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle4;
